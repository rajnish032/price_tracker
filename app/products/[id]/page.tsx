  ...
  return (
    <div className='flex flex-col gap-16 flex-wrap px-6 md:px-20 py-24'>
       ...
       <div className='flex items-center flex-wrap gap-10 py-6 border-y border-y-[#E4E4E4]'>
           ...
           <div className='flex flex-col gap-4'>
            ...
            <p className='text-sm text-black opacity-50'>
                <span className='text-green-400 font-semibold'>93%</span> of buyers have recommeded this.
            </p>
      ...
      <div className='flex flex-col gap-16'>
        ...
        <button className=' bg-gray-800 py-4 px-4 bg-secondary hover:bg-opacity-70 rounded-[30px] text-white text-lg font-semibold w-fit mx-auto flex items-center justify-center gap-3 min-w-[200px'>
            <Image 
